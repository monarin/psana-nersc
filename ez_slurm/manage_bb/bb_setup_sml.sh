...
mkdir -p $DW_PERSISTENT_STRIPED_myBBsml/d/psdm/cxi/cxid9114/xtc
...
cp -r /global/cscratch1/sd/monarin/d/psdm/cxi/cxid9114/xtc/index $DW_PERSISTENT_STRIPED_myBBsml/d/psdm/cxi/cxid9114/xtc/
