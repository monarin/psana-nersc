...
1. On psbuild-rhel7 or any other nodes with internet access, wget both the primary and secondary mcs files of the requested version from this [pgp-pcie releases page](https://github.com/slaclab/cameralink-gateway/releases](https://github.com/slaclab/lcls2-pgp-pcie-apps/releases/tag/v3.7.0).
