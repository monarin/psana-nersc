...
def setup_input_files(tmp_path):
    ...
    for i in range(n_files):
        ...
        subprocess.call(['xtcwriter','-f',s01file,'-t','-n','100000','-s',str(i*2),'-e','100000','-m','2']) # ask for 100 steps (-m) with 100k events per step (-n) with every 1M events, one SlowUpdate inserted (-e).
